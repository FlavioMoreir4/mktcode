...
@section('content')
    <section class="flex min-h-[80vh] flex-col items-center justify-center px-6 py-24 text-center">
        <p class="mb-8 select-none text-[9rem] font-black leading-none tracking-tighter text-primary/[0.06] md:text-[12rem]" aria-hidden="true">404</p>
        <div class="max-w-md">
            <h1 class="mb-3 text-3xl font-bold tracking-tight md:text-4xl">Página não encontrada</h1>

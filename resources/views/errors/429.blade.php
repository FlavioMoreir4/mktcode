...
@section('content')
    <section class="flex min-h-[80vh] flex-col items-center justify-center px-6 py-24 text-center">
        <p class="mb-8 select-none text-[9rem] font-black leading-none tracking-tighter text-primary/[0.06] md:text-[12rem]" aria-hidden="true">429</p>
        <div class="max-w-md">
            <h1 class="mb-3 text-3xl font-bold tracking-tight md:text-4xl">Muitas requisições</h1>
            <p class="mb-10 text-base leading-relaxed text-muted-foreground">
                Você fez muitas requisições em um curto período de tempo. Tente novamente mais tarde.
            </p>

...
class PostSeoBuilder implements SeoDataBuilder
{
    ...
    public function build(object $post): SeoData
    {
        if (! $post instanceof Post) {
            throw new InvalidArgumentException('PostSeoBuilder expects a Post model.');
        }
